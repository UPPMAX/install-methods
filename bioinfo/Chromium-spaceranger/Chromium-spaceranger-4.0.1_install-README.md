...
Structure creating script (makeroom_Chromium-spaceranger_4.0.1.sh) moved to /sw/bioinfo/Chromium-spaceranger/makeroom_4.0.1.sh

LOG
---

    /home/bjornv/git/install-methods/makeroom.sh "-t" "Chromium-spaceranger" "-m" "spaceranger" "-v" "4.0.1" "-w" "https://support.10xgenomics.com/spatial-gene-expression/software/pipelines/latest/what-is-space-ranger" "-c" "bioinfo" "-s" "misc" "-d" "set of analysis pipelines that process Visium spatial RNA-seq output and brightfield microscope images in order to detect tissue, align reads, generate feature-spot matrices, perform clustering and gene expression analysis, and place spots in spatial context on the slide image" "-f"
    ./makeroom_Chromium-spaceranger_4.0.1.sh
    ...
    wget -O spaceranger-4.0.1.tar.gz
    "https://cf.10xgenomics.com/releases/spatial-exp/spaceranger-4.0.1.tar.gz?Expires=1761947527&Key-Pair-Id=APKAI7S6A5RYOXBWRPDA&Signature=hwuVEVTj0dNuox0iTJmSmCPVIa61HWVI-Wm7cDPjr4Y~wthqeO9nwCTf~DLpcA9rKXd3blJ9izlFjVV9h~SsoLejDk188MBCgVlyHdaMnILRXGUkROj~GSG4sz8AviIPXVS0x-7ElwT9~XeK9rWL7no7hiUTxpn0kWdh2xetubD60WCorxlzy7huB0R0~U5br84j69YSx4DwYKU33VBsWwFhwHqyPLi5sYeRNhnTImd3pICiscLhpbL7a3sli9fMg5Ugs2kY~WLpBPbFEbY-J8I3axv28ZfKb0xTL435olFes0S2ZX7FvrHlSk~juH4jqsUbnFIBn~5altluHgm9Ww__"

    echo "md5 from download site is b0beb100947717cee8c7ad0d7a9f0247"
    ...
    cd $PREFIX
    ./spaceranger testrun --id=test_small
...
Now get additional data sources and add them. For `$PREFIX/probe_sets/`.
    ...
    wget https://cf.10xgenomics.com/supp/spatial-exp/probeset/Visium_Human_Transcriptome_Probe_Set_v2.1.0_GRCh38-2024-A.bed
    wget https://cf.10xgenomics.com/supp/spatial-exp/probeset/Visium_Human_Transcriptome_Probe_Set_v2.1.0_GRCh38-2024-A.csv
    wget https://cf.10xgenomics.com/supp/spatial-exp/probeset/Visium_Human_Transcriptome_Probe_Set_v2.1.0_GRCh38-2024-A.offtarget.csv
    wget https://cf.10xgenomics.com/supp/spatial-exp/probeset/Visium_Human_Transcriptome_Probe_Set_v2.1.0_GRCh38-2024-A.probe_metadata.tsv
    ...
    wget https://cf.10xgenomics.com/supp/spatial-exp/probeset/Visium_Mouse_Transcriptome_Probe_Set_v2.0_mm10-2020-A.bed
    wget https://cf.10xgenomics.com/supp/spatial-exp/probeset/Visium_Mouse_Transcriptome_Probe_Set_v2.0_mm10-2020-A.csv
    wget https://cf.10xgenomics.com/supp/spatial-exp/probeset/Visium_Mouse_Transcriptome_Probe_Set_v2.0_mm10-2020-A.offtarget.csv
    wget https://cf.10xgenomics.com/supp/spatial-exp/probeset/Visium_Mouse_Transcriptome_Probe_Set_v2.0_mm10-2020-A.probe_metadata.tsv
    wget https://cf.10xgenomics.com/supp/spatial-exp/probeset/Visium_Mouse_Transcriptome_Probe_Set_v2.0_mm10-2020-A.probe_metadata.xlsx
    wget https://cf.10xgenomics.com/supp/spatial-exp/probeset/Visium_Mouse_Transcriptome_Probe_Set_v2.1.0_GRCm39-2024-A.bed
    wget https://cf.10xgenomics.com/supp/spatial-exp/probeset/Visium_Mouse_Transcriptome_Probe_Set_v2.1.0_GRCm39-2024-A.csv
    wget https://cf.10xgenomics.com/supp/spatial-exp/probeset/Visium_Mouse_Transcriptome_Probe_Set_v2.1.0_GRCm39-2024-A.offtarget.csv
    wget https://cf.10xgenomics.com/supp/spatial-exp/probeset/Visium_Mouse_Transcriptome_Probe_Set_v2.1.0_GRCm39-2024-A.probe_metadata.tsv
    wget https://cdn.10xgenomics.com/raw/upload/v1684779414/software-support/Spatial-GEX/SR-v2.1/Visium_Human_Immune_Cell_Profiling_Panel_v1.0.csv
    rsync -Pa Visium_* $PREFIX/probe_sets/
    
# For the new directory `$PREFIX/index_kits/`.
    mkdir $PREFIX/index_kits
    wget https://cdn.10xgenomics.com/raw/upload/v1755619980/software-support/index-sets/Dual_Index_Kit_TT_Set_A.csv
    wget https://cdn.10xgenomics.com/raw/upload/v1755619980/software-support/index-sets/Dual_Index_Kit_TT_Set_A.json
    wget https://cdn.10xgenomics.com/raw/upload/v1755619977/software-support/index-sets/Dual_Index_Kit_TS_Set_A.csv
    wget https://cdn.10xgenomics.com/raw/upload/v1755619977/software-support/index-sets/Dual_Index_Kit_TS_Set_A.json

...
Structure creating script (makeroom_Seurat_5.3.0.sh) moved to /sw/bioinfo/Seurat/makeroom_5.3.0.sh

LOG
---

    makeroom.sh "-t" "Seurat" "-v" "5.3.0" "-w" "https://cran.r-project.org/web/packages/Seurat/index.html" "-c" "bioinfo" "-s" "pipelines" "-l" "MIT" "-d" "A toolkit for quality control, analysis, and exploration of single cell RNA sequencing data. This module provides Seurat v5" "-f"
    ./makeroom_Seurat_5.3.0.sh
    source /sw/bioinfo/Seurat/SOURCEME_Seurat_5.3.0 && cd $SRCDIR
    ml R_packages/4.3.1
    ml hdf5/1.14.0    

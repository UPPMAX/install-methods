...
Structure creating script (makeroom_Seurat_5.2.1.sh) moved to /sw/bioinfo/Seurat/makeroom_5.2.1.sh

LOG
---

    /home/bjornc/UPPMAX-tools/install-methods/makeroom.sh "-t" "Seurat" "-v" "5.2.1" "-w" "https://cran.r-project.org/web/packages/Seurat/index.html" "-c" "bioinfo" "-s" "pipelines" "-l" "MIT" "-d" "A toolkit for quality control, analysis, and exploration of single cell RNA sequencing data. This module provides Seurat v5" "-f"
    ./makeroom_Seurat_5.2.1.sh
    source /sw/bioinfo/Seurat/SOURCEME_Seurat_5.2.1 && cd $SRCDIR
    ml R_packages/4.3.1
    ml hdf5/1.14.0    
...
BPCells needs some special treatment
    wget wget https://github.com/bnprks/BPCells/archive/refs/tags/v0.3.0.tar.gz
    tar xzvf v0.3.0.tar.gz
    cp -r BPCells-0.3.0 BPCells-0.3.0_fix
    vim BPCells-0.3.0_fix/r/configure
  change lines ~40
        HDF5_CFLAGS="${HDF5_CFLAGS-}"
        HDF5_LIBS="${HDF5_LIBS--lhdf5}"
    cd BPCells-0.3.0_fix
...
Other
    ...
    remotes::install_github("https://github.com/dmcable/spacexr", upgrade=FALSE)

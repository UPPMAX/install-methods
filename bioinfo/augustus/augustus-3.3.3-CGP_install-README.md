...
---
    ...
    wget https://github.com/Gaius-Augustus/Augustus/releases/download/v${TOOLVERSION}/augustus-${TOOLVERSION}.tar.gz
...
Structure creating script (makeroom_augustus_3.3.3-CGP.sh) moved to /sw/bioinfo/augustus/makeroom_3.3.3-CGP.sh
...
---
    ...
    SRCDIR=/sw/bioinfo/augustus/3.3.3-CGP/src
    /home/douglas/bin/makeroom.sh -f" -t "augustus" -v "3.3.3-CGP" -s "annotation" -w "http://bioinf.uni-greifswald.de/augustus" -l "Artistic" -d "find genes and their structures in one or more genomes"
    ./makeroom_augustus_3.3.3-CGP.sh
augustus/3.3.3-CGP
========================

...
Structure creating script (makeroom_blast_2.16.0+.sh) moved to /sw/bioinfo/blast/makeroom_2.16.0+.sh
...
---
    ...
    /home/douglas/bin/makeroom.sh "-f" "-t" "blast" "-v" "2.16.0+" "-w" "https://blast.ncbi.nlm.nih.gov/Blast.cgi" "-l" "Public Domain" "-L" "https://www.ncbi.nlm.nih.gov/IEB/ToolBox/CPP_DOC/lxr/source/scripts/projects/blast/LICENSE"
    ./makeroom_blast_2.16.0+.sh

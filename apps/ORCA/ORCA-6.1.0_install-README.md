...
Structure creating script (makeroom_ORCA_6.1.0.sh) moved to /sw/apps/ORCA/makeroom_6.1.0.sh

LOG
---

    /home/bjornv/git/install-methods/makeroom.sh "-t" "ORCA" "-v" "6.1.0" "-w" "https://orcaforum.kofo.mpg.de/" "-d" "ORCA is a quantum-chemical software package consisting of methods in the fields of density functional theory as well as correlated wave-function based methods." "-c" "apps" "-f"
    ./makeroom_ORCA_6.1.0.sh
    ...
    # orca_6.1.0_linux_x86-64_avx2_shared_openmpi416.tar.xz
    # orca_6.1.0_linux_x86-64_shared_openmpi416.tar.xz
    # CompoundScripts-ORCA_6_1_0.tar.gz
...
### rackham ###
    ...
    tar xfl orca_6_1_0_linux_x86-64_shared_openmpi418_avx2.tar.xz
    mv orca_6_1_0_linux_x86-64_shared_openmpi418_avx2 $PREFIX/bin
    cd $PREFIX/bin
    ldd * | grep "not found"
    cd $PREFIX
    tar xfvz CompoundScripts-ORCA_6_1_0.tar.gz
    mv Third_Party_Licenses_Academic_6.1.pdf CompoundScripts/ EULA_ORCA_2021.pdf ../

### Snowy ###
    cd $SRCDIR
    tar xfl orca_6_1_0_linux_x86-64_shared_openmpi418.tar.xz
    mv orca_6_1_0_linux_x86-64_shared_openmpi416 $TOOLDIR/$VERSION/snowy/bin
    ...
    # Test
    cd $PREFIX/CompoundScripts-ORCA_6_1_0/UserContributed/XYG3TypeDoubleHybrids/
    $PREFIX/bin/orca test.inp 

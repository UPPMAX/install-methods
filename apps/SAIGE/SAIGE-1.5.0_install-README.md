...
Structure creating script (makeroom_SAIGE_1.5.0.sh) moved to /sw/apps/SAIGE/makeroom_1.5.0.sh

LOG
---

    /home/bjornc/UPPMAX-tools/install-methods/makeroom.sh "-f" "-t" "SAIGE" "-v" "1.5.0" "-c" "apps" "-w" "https://github.com/weizhouUMICH/SAIGE" "-l" "GPL v3" "-d" "An R package with Scalable and Accurate Implementation of Generalized mixed model \(Chen\, H. et al. 2016\). It accounts for sample relatedness and is feasible for genetic association tests in large cohorts and biobanks \(N \> 400\,000\)."
    ./makeroom_SAIGE_1.5.0.sh
SAIGE/0.44.6.5
==============
...
---
    ...
    /home/bjornc/UPPMAX-tools/install-methods/makeroom.sh "-f" "-t" "SAIGE" "-v" "1.5.0" "-c" "apps" "-w" "https://github.com/saigegit/SAIGE" "-l" "GPL v3" "-d" "SAIGE is an R package developed with Rcpp for genome-wide association tests in large-scale data sets and biobanks.  \(N \> 400\,000\)."
    ./makeroom_SAIGE_1.5.0.sh

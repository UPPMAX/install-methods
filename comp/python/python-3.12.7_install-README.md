...
Structure creating script (makeroom_python_3.12.7.sh) moved to /sw/comp/python/makeroom_3.12.7.sh
...
---
    ...
    makeroom.sh "-f" "-t" "python" "-v" "3.12.7" "-c" "comp" "-w" "https://python.org/" "-l" "PSF License Agreement" "-L" "https://docs.python.org/3/license.html" "-d" "Python programming language plus a handful of widely used packages"
    ./makeroom_python_3.12.7.sh


    source /sw/comp/python/SOURCEME_python_3.12.7
    cd $SRCDIR

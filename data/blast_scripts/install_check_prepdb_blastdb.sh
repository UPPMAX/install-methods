...
# if set, do a blastdbcheck to verify the soundness of each database. one of
# the files of one was 0-sized once, and hopefully this would have caught it
checkdbs=yes

# if set, do a 'diamond prepdb' for each protein database, those with *.pal
